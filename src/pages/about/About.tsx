  ...
  return (
    <Box sx={styles.wrapper} data-testid="about-page">
      ...
      <Text>
        ...
        interests (React, Full Stack, Blockchain, etc.) and gain a personalized
        experience. Consumers can browse, search topics, or follow specific
        developers. TDV acts as a living portfolio. Instead of fragmented
        personal blogs and portfolios, developers get a unified profile (e.g.,
        thedigitalvanguard.io/johndoe), linking all their articles, thoughts,
        and projects in one place. This fosters a strong, exclusive
        community—being part of the Vanguard.
      </Text>
      <Heading size="md" sx={styles.subHeader}>
        {"For Consumers"}
      </Heading>
      <Text>
        ...
        topics like “Full Stack” or “FinTech” and discover top-ranked developers
        based on engagement (likes, shares, and ‘helpful’ feedback). The more a
        developer contributes, the higher they rank.
      </Text>
      <Heading size="md" sx={styles.subHeader}>
      ...
      <Text>
        ...
        progress tracking • A place to link the finished project (e.g., a hosted
        site or demo video) TDV even guides users in deploying projects at the
        lowest cost, ensuring work isn’t lost but becomes a shareable portfolio
        piece.
      </Text>
      <Heading size="md" sx={styles.subHeader}>
